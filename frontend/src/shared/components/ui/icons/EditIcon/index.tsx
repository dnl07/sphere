...
const EditIcon = (props: IconProps) => {
    return (
        <IconBase {...props}>
            <path d="M11 2H4C2.89543 2 2 2.89543 2 4V20C2 21.1046 2.89543 22 4 22H20C21.1046 22 22 21.1046 22 20V14" strokeLinecap="round"/>
            ...
            <path d="M12.8107 15.0022L7.86074 15.8969" strokeLinecap="round"/>
            <path d="M9.09338 11.285L7.86074 15.8969" strokeLinecap="round"/>
        </IconBase>
    );
}
