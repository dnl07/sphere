    ...
    return (
        <div className="bg-bg-elevated w-60 fixed h-dvh px-4 flex flex-col shadow-xl ">
            ...
            <nav className="flex flex-col gap-2 mt-2">
                <SideBarNavLink onClick={clickOnLink} to="/closet" label="Closet" />
                <SideBarNavLink onClick={clickOnLink} to="/atelier" label="Atelier" />
                <SideBarNavLink onClick={clickOnLink} to="/faq" label="FAQ" />
                <SideBarNavLink onClick={clickOnLink} to="/about" label="About" />
            </nav>
