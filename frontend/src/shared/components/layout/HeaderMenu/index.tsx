...
const HeaderMenu = ({ open, closeMenu }: Props) => {
    return (
        <div
            className={`bg-bg fixed h-screen top-0 z-20 pr-10 pl-10 pt-16 right-0 transition-all ease-in-out duration-500 ${open ? "translate-0 shadow-2xl" : "translate-x-full"}`}
        >
