    ...
    return (
        <>
            <div className="flex flex-row gap-5 mr-1">
                <button className=""><EditIcon color="#000000" strokeWidth={1.5} className="w-7.5 h-7.5"/></button>
                <button onClick={() => setShowDialog(true)}><DeleteIcon color="#000000" strokeWidth={1.25} className="w-8 h-8" /></button>
            </div>     
            {showDialog && 
