...
namespace Sphere.Infrastructure.Services.SearchEngine {
    public class SearchEngineService : ISearchEngineService {
        ...
        public async Task<string> IndexItemAsync(string name, string? description, CancellationToken ct = default) {
            ...
            try {
                ...
                _logger.LogDebug("Item {name} successfully indexed", name);
                ...
                _logger.LogError(e, "Error occurred while indexing item: {Name}", name);
                throw;
            }
        }
